...
class Calculator(Frame):
    ...
    def create_widgets(self):
        ...
        :return: None
        """
        self.sin_bttn = Button(self, text="tan", width=9, height=3, bg="pink", command=lambda: self.add_chr("tan"))
        self.sin_bttn.grid(row=4, column=6)
        
        self.sin_bttn = Button(self, text="cos", width=9, height=3, bg="purple", command=lambda: self.add_chr("cos"))
        self.sin_bttn.grid(row=3, column=6)
        
        self.sin_bttn = Button(self, text="sin", width=9, height=3, bg="green", command=lambda: self.add_chr("sin"))
        ...
        self.one_bttn = Button(self, text="Daniel", width=9, height=3,bg='LightBlue', fg='red', command=lambda: self.add_chr("Medina"))
...
root = Tk()
root.geometry()
root.title("Demo Project 1:calcGUI - Daniel Medina")
app = Calculator(root)
root.mainloop()
